...
@Table(
        name = "traders",
        uniqueConstraints = @UniqueConstraint(name = "uk_trader_company_code", columnNames = {"company_id","domain","code"}),
        indexes = {
                @Index(name = "idx_trader_company_domain", columnList = "company_id, domain")
        }
)
...
public class Trader {
        ...
        @JoinColumn(name = "company_id", insertable = false, updatable = false,
                foreignKey = @ForeignKey(name = "fk_trader_company"))
        private Company company;

        @Convert(converter = TraderDomainConverter.class)
        @Column(name = "domain", nullable = false, length = 20)
        private TraderDomain traderDomain;
        ...
        @JoinColumn(name = "country_id", nullable = false,
                foreignKey = @ForeignKey(name = "fk_trader_country"))
        ...
        public TraderDomain getTraderDomain() {
            return traderDomain;
        }
